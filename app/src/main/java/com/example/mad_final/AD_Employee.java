...
public class AD_Employee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomeValidation.addValidation(this, R.id.emp7, RegexTemplate.NOT_EMPTY, R.string.invalid_salary);
        ...
        b4.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Integer deletedRows = mydb.deleteDetail(m5.getText().toString());
                        if (deletedRows > 0)
